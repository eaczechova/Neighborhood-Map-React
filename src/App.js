...
class App extends Component {
  ...
  filterMarkers = () => {
    let marker = this.state.markers.filter(item => {
      return item.name === "Dom" });
    // this.setState( { markers: this.state.markers.push( {lat:52.2694760000,
    //   lng: 20.9853330000,
    //   name: "Jaskółka",
    // })})
    console.log("selectedMarker",  marker)
    console.log("test", this.state.markers)
  }
